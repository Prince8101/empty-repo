...
bot = telebot.TeleBot('7139342062:AAHgTHj8tinuPGFp0iBKy7En6q75u3grdUo')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = """❌ You Are Not Authorized To Use This Command ❌.
                      🛒 Please Buy From @Gucci_premium_hack"""
...
🚀 Buy From :- @Gucci_premium_hack
🚀 Official Channel :- https://t.me/+qcSFVVPIYm01ODdl
'''
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to The Bot, ™『Gucci premium hack』™ 💖
                    🤖Feel Free to Explore. 
                    ✅Join :- https://t.me/+qcSFVVPIYm01ODdl'''
    bot.reply_to(message, response)
